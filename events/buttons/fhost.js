...
module.exports = {
    ...
    async execute(client, i) {
        ...
        if (i.customId === 'fhost-✅' && i.message.content.slice(2, -1) == i.user.id) {
        ...
        if (doFilterCheck && i.customId == 'fhost-❌' && allIDs.includes(i.user.id) && i.message.content.slice(2, -1) != i.user.id) {
        ...
        } else if (doFilterCheck && i.customId == 'fhost-❌' && allIDs.includes(i.user.id) && i.message.content.slice(2, -1) == i.user.id) {
